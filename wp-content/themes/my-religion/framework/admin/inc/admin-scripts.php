...
function my_religion_admin_register($hook) {
	...
	wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
		'clear' => 					__('Clear', 'my-religion'),
		'clearAriaLabel' => 		__('Clear color', 'my-religion'),
		'defaultLabel' => 			__('Color value', 'my-religion'),
		'defaultString' => 			__('Default', 'my-religion'),
		'defaultAriaLabel' => 		__('Select default color', 'my-religion'),
		'pick' => 					__('Select Color', 'my-religion'),
	) ); 
